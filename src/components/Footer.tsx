  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: Facebook,
      href: "https://www.facebook.com/BeautyUniversebeauteDz",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/auth" className={`text-background/70 hover:text-primary transition-colors flex items-center gap-2 ${dir === 'rtl' ? 'flex-row-reverse justify-end' : ''}`}>
                  <span className="w-1.5 h-1.5 rounded-full bg-primary/50" />
              ...
              <li className={`flex items-start gap-3 ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                ...
                <div className={dir === 'rtl' ? 'text-right' : 'text-left'}>
                  <p className="text-background/70 text-sm leading-relaxed">
                    {language === 'ar' ? '04 Rue ahmed ait mohand el harrach, Algiers, Algeria' : '04 Rue ahmed ait mohand el harrach, Algiers, Algeria'}
                  </p>
                </div>
              </li>
              <li>
                <a
                  href="tel:+213555852522"
                ...
                >
                  ...
                  <p className="text-background/70 text-sm" dir="ltr">+213 771 51 41 01</p>
                </a>
              </li>
              <li>
                <a
                  href="mailto:slimane.tfyeche@gmail.com"
                  className={`flex items-center gap-3 hover:text-primary transition-colors ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}
                >
                  <div className="w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center flex-shrink-0">
                    <Mail className="w-4 h-4 text-primary" />
                  </div>
                  <p className="text-background/70 text-sm">slimane.tfyeche@gmail.com</p>
                </a>
              </li>
              <li>
                <a
            ...
            <div className="bg-background/5 border border-background/10 rounded-xl p-5">
              <div className="space-y-3 text-sm">
                <div className={`flex justify-between items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <span className="text-background/70">Monday</span>
                  <span className="text-background font-medium">8:00 AM - 1:00 PM / 2:00 PM - 7:00 PM</span>
                </div>
                <div className={`flex justify-between items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <span className="text-background/70">Tuesday</span>
                  <span className="text-background font-medium">8:00 AM - 1:00 PM / 2:00 PM - 7:00 PM</span>
                </div>
                <div className={`flex justify-between items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <span className="text-background/70">Wednesday</span>
                  <span className="text-background font-medium">8:00 AM - 1:00 PM / 2:00 PM - 7:00 PM</span>
                </div>
                <div className={`flex justify-between items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
                  <span className="text-background/70">Thursday</span>
                  <span className="text-background font-medium">8:00 AM - 1:00 PM / 2:00 PM - 7:00 PM</span>
                </div>
                <div className={`flex justify-between items-center ${dir === 'rtl' ? 'flex-row-reverse' : ''}`}>
