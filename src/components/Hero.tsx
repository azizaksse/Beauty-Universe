      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`max-w-2xl mx-auto text-center`}>
          ...
          <div className="animate-fade-in mb-8">
            <span className="inline-flex items-center gap-2 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md border border-white/30 text-white px-5 py-2 rounded-full text-sm font-semibold shadow-lg shadow-white/10 animate-pulse">
